...
plt.title('Time plot of model 7. Regression Residuals 2010')
Error_10.plot(label='Regression Residuals', legend=True, color="black")
plt.show()

plot_acf(Error_10, title='ACF of model 7. Regression Residuals 2010', lags=40)
plt.show()
